...
<link rel="stylesheet" href="{{ asset ('css/bootstrap-utilities/utilities.css') }}">
    ...
    @section('script')
        <script type="text/javascript">
            ...
            $(function () {
                var id_ad_privileges = '{{$id_ad_privileges}}';
                        ...
                        <ul class='draggable-menu draggable-menu-active list-disc space-y-2'>
                            @foreach($menu_active as $menu)
                                @php
                                    ...
                                    ->where('id_ad_menus',$menu->id)->pluck('ad_privileges.name')->toArray();
                                @endphp
            ...
            <div class="col-sm-7">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form class='form-horizontal' method='post' id="form" enctype="multipart/form-data" action='{{App\Helpers\CommonHelpers::mainpath("add-save")}}'>
